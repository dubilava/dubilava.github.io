...
google_cites <- if (!is.null(prof) && !is.na(prof$total_cites)) as.character(prof$total_cites) else "Unavailable"
google_index <- if (!is.null(prof) && !is.na(prof$h_index)) as.character(prof$h_index) else "Unavailable"

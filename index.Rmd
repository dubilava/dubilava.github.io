...
google_cites <- if (is.list(prof) && !is.null(prof$total_cites) && !is.na(prof$total_cites)) as.character(prof$total_cites) else "Unavailable"
google_index <- if (is.list(prof) && !is.null(prof$h_index) && !is.na(prof$h_index)) as.character(prof$h_index) else "Unavailable"
...
I currently serve as a co-editor-in-chief of *Food Policy* (from 2026), where I served as a co-editor (from 2018 to 2025). Previously, I also served as an associate editor of the *American Journal of Agricultural Economics* (from 2022 to 2025), and an associate editor of the *Australian Journal of Agricultural and Resource Economics* (from 2020 to 2021).

I co-organize [Social Conflict and Political Economy (SCoPE)](https://sydneyscope.org/) workshop series.

**Popular writing:**

- [Fertiliser costs are soaring amid war in the Middle East. Will your grocery bill follow?](https://theconversation.com/fertiliser-costs-are-soaring-amid-war-in-the-middle-east-will-your-grocery-bill-follow-277511)
...
- [Closed-Book vs Open-Web](https://dubilava.github.io/misc/openclosed/openclosed.html){target="_blank"}
...
- [Academic Publishing: Getting it Right and Making it Work](https://dubilava.github.io/misc/publishing/presentation.html){target="_blank"}
</div>
</div>

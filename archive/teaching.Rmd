...
quote_footer <- function(x) {
  if (requireNamespace("tufte", quietly = TRUE)) tufte::quote_footer(x) else paste0("— ", x)
}
```
...
>
`r quote_footer('ECMT3130: Forecasting for Economics and Business, Semester 2 2021')`
...
>
`r quote_footer('ECOS3013: Environmental Economics, Semester 2 2020')`

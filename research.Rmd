...
--\ [Agricultural Roots of Social Conflict in Southeast Asia](https://arxiv.org/abs/2304.10027){target="_blank"} *(with Justin Hastings)*.

## Publications

[24]\ Ubilava, D. (accepted). Climate, Crops, and Postharvest Conflict. *American Journal of Agricultural Economics* [Working Paper](https://arxiv.org/abs/2311.16370){target="_blank"}.
